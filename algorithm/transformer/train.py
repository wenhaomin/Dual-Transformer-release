...
from algorithm.transformer.model import VanillaTransformer, save2file
...
def main(params):
    ...
    # directly pass a normalizer later
...
if __name__ == '__main__':
    ...
    FEATURE_LIST = [
        ...
        # discrete
        {'idx': 4, 'name': 'poi', 'type': 'discrete', 'class_num': 7, 'is_predict': 'yes'}, # note: for trial3 the poi class num is 7, for trial 2, the poi class num is 40
    ...
    # for test the code
    # params['dataset'] = 'trial2_dow_test'
    params['dataset'] = 'trial2_dow_test'
