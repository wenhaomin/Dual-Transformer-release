...
from algorithm.dual_transformer.model import DualTransformer, save2file
...
def main(params):
    ...
    params['model_save2file'] = (DualTransformer, save2file)
...
if __name__ == '__main__':
    ...
    # workers = 16 if platform.system() == 'Linux' else 1
