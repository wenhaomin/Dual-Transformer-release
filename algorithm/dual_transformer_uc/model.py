...
class DualTransformer(nn.Module):
    ...
    def __init__(self, args: dict):
        ...
        # self.feature_transformer = nn.TransformerEncoder(nn.TransformerEncoderLayer(d_model=self.d_h, nhead=self.num_head, batch_first=True, dropout=self.dropout), num_layers=self.num_layer)
...
def save2file(params):
    file_name = ws + f'/output/metrics/dual_tr_au_eu.csv'
    head = [
        # data setting
        'dataset', 'seed',
        # model parameters
